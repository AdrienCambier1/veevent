        ...
        <div className="flex flex-col gap-12 lg:col-span-2">
          <div className="flex flex-col gap-6">
            ...
            <p>
              ...
              édition encore plus spectaculaire ! Pendant quatre jours, artistes
              botaniques, paysagistes et passionnés de nature uniront leur
              créativité pour donner vie à des fresques monumentales réalisées
              exclusivement à partir de plantes, mousses et fleurs locales. 🖌️
              Création en direct : Assistez à la conception d’une fresque
              végétale de 20 mètres de long, illustrant l’harmonie entre l’homme
              et la nature, façonnée à partir de lichen, de fougères et de
              pétales soigneusement sélectionnés. 🌺 Ateliers participatifs :
              Initiez-vous à l’art de la fresque verte en apprenant à composer
              de petites œuvres murales avec du végétal stabilisé et des
              substrats naturels. 🌿 Conférences & rencontres : Experts en
              permaculture et en art écologique partageront leur savoir lors de
              conférences sur l’impact positif des fresques végétales en milieu
              urbain. 🎶 Ambiance immersive : Chaque soir, des concerts
              acoustiques et des performances de danse contemporaine viendront
              sublimer les créations végétales dans une atmosphère féerique. 🥗
              Espace gourmand : Découvrez des saveurs locales et responsables
              avec nos stands de restauration bio et zéro déchet. Que vous soyez
              artiste en herbe, amoureux de la nature ou simple curieux,
              laissez-vous émerveiller par cette célébration unique du vivant !
              🌱✨
            </p>
          </div>
          <div className="flex flex-col gap-6">
